...
export default function Profile() {
    ...
    async function followUser(){
        ...
        try{
            ...
            await tx.wait(); 
            console.log("Followed user succesffuly");
        } catch (error){
            console.log("Failed to follow user due to ", error);
        }
    }
        ...
        <Layout>
            ...
            <div className="grow-1 w-full">
                <div className="text-center md:text-left">
                    ...
                    <h1 className="text-xl font-bold text-gray-500 sm:text-2xl sm:tracking-tight mb-2">
                        {profile.handle}
                    </h1>
